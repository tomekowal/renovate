...
describe('modules/versioning/hex/index', () => {
  it.each`
    ...
    ${'0.3.0'} | ${'~> 0.2'}               | ${true}
    ${'1.0.0'} | ${'~> 0.2'}               | ${false}
    ${'0.3.0'} | ${'~> 0.2 or ~> 1.0'}     | ${true}
    ${'0.3.0'} | ${'~> 0.2 and >= 0.2.1'}  | ${true}
    ${'1.5.0'} | ${'~> 1.0 or ~> 2.0'}     | ${true}
  `(
  ...
  it.each`
    ...
    ${['0.22.0', '0.23.0', '1.0.0']}                 | ${'~> 0.22'}  | ${'0.23.0'}
  `(
  ...
  it.each`
    ...
    ${'>= 1.0.0 or <= 2.0.0'}  | ${'replace'}         | ${'1.2.3'}     | ${'2.0.7'} | ${'>= 1.0.0 or <= 2.0.0'}
    ${'~> 0.4'}                | ${'replace'}         | ${'0.4.2'}     | ${'0.6.0'} | ${'~> 0.4'}
    ${'~> 1.0'}                | ${'widen'}           | ${'1.0.0'}     | ${'2.0.0'} | ${'~> 1.0 or ~> 2.0'}
    ${'~> 1.0.0'}              | ${'widen'}           | ${'1.0.0'}     | ${'2.0.0'} | ${'~> 1.0.0 or ~> 2.0.0'}
    ${'~> 0.2'}                | ${'widen'}           | ${'0.2.0'}     | ${'0.3.0'} | ${'~> 0.2'}
    ${'~> 0.2'}                | ${'widen'}           | ${'0.2.0'}     | ${'1.0.0'} | ${'~> 0.2 or ~> 1.0'}
    ${'~> 0.2'}                | ${'update-lockfile'} | ${'0.2.0'}     | ${'0.3.0'} | ${'~> 0.2'}
    ${'~> 0.5.4 or ~> 0.6'}    | ${'widen'}           | ${'0.6.0'}     | ${'0.8.0'} | ${'~> 0.5.4 or ~> 0.6'}
    ${'~> 0.2 or ~> 1.0'}      | ${'widen'}           | ${'0.2.0'}     | ${'0.3.0'} | ${'~> 0.2 or ~> 1.0'}
  `(
